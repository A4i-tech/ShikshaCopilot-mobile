...
/// A widget that displays a section of dropdowns for lesson details.
class LessonDetailsDropdownSection
    extends GetView<LessonPlanGenerationDetailsController> {
  /// Creates a [LessonDetailsDropdownSection] object.
  const LessonDetailsDropdownSection({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) => Obx(() {
    String? infoText;
    final LessonPlanTemplateModel? lessonPlan =
        controller.lessonPlanTemplate.value;
    if (lessonPlan != null && lessonPlan.data.isNotEmpty) {
      infoText = lessonPlan.data[0].description;
    } else {
